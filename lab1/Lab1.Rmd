...
Для отримання інформації потрібно агрегувати дані використовуючи функцію aggregate:
...
Для отримання інформації агрегуємо лише ті записи, що мають fips == 25410:
